...
/*
 * g++ -o lab3executable main_lab2.cpp framebuffer.cpp linedrawer.cpp camera.cpp sphere.cpp scene.cpp triangle.cpp polymesh.cpp -lm -O3
 *
 * Execute the code using ./lab3executable
 *
 * pnmtopng test-lab3.ppm > test-lab3.png
 */
...
int main(int argc, char *argv[])
{
  ...
  fb->writeDepthFile((char *)"test-lab3.ppm");
